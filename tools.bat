...
if exist "V6" goto updateencontrado
cd ..
...
if %o3% equ 6 goto fixerroeapostualizar
...
cls
echo ===============================================
echo Quer gerar um erro no seu computador?
echo Tela azul?
echo ===============================================
echo [1] Sim
echo [2] Nao
set /p bsod=Digite o numero da opcao: 
if %bsod% equ 1 goto bsod
if %bsod% equ 2 goto a
goto certezabsod

:bsod
cls
echo Dando tela azul
echo Gerando erro...
powershell wininit
powershell wininit
powershell wininit
...
wmic product where name="Microsoft Edge Beta" call uninstall /nointeractive
wmic product where name="Microsoft Edge Dev" call uninstall /nointeractive
wmic product where name="Microsoft Edge Canary" call uninstall /nointeractive
cd %temp%
cd ..
rd /s /q Temp
md Temp
...
:dowupd
cls
set /p fileupdateaaeef=Digite o local do arquivo: 
if exit %fileupdateaaeef% goto exist upcab
...
echo LOG
echo Fleshando...
dism /Online /Add-Package /PackagePath:"%fileupdateaaeef%" /norestart
echo PASS!!
echo ========================
